...
- `labarchive-integration` - 电子实验室笔记本
...
- `scikit-learn` - 聚类和分类
- `umap-learn` - 降维
- `statistical-analysis` - 人口统计
- `matplotlib` - 流式细胞术图
- `plotly` - 交互式门控
- `clinical-reports` - 临床流程报告
