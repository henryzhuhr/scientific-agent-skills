# Cell Press 摘要、要点和 eTOC 示例

Cell Press 特定元素的示例，包括摘要（摘要）、要点和 eTOC 模糊。
...
1. **第一句话**：建立生物背景
2. **第二句**：说明未知的内容（差距）
3. **“在这里，我们展示/识别/演示”**：清晰地过渡到您的作品
4. **中间句子**：机制
5的主要发现。 **最后一句**：意义和含义

### 重点提示

- **以名词或动词开头**：“FOXO4 形成...”或“激活...”
- **每个项目符号一个发现**：不要组合多个点
- **具体**：包括蛋白质/基因/途径name
- **检查字符数**：严格≤85个字符，包括空格
- **涵盖不同的发现**：不要重复同一点
...
- `cell_press_style.md` - 综合细胞出版社写作指南
- `nature_abstract_examples.md` - 与自然抽象风格比较
