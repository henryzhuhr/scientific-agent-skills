...
要查找任何端点的可用字段，请请求一个小样本并检查 `meta.labels` 和 `meta.dataTypes`:
...
浏览 54 个数据集和 182 个端点的完整列表：
- `https://fiscaldata.treasury.gov/datasets/` — 可搜索的数据集目录
- `https://fiscaldata.treasury.gov/api-documentation/#list-of-endpoints-table` — 完整端点表
