...
|卫星|操作员|分辨率|重访 |主要特点|
|------------|---------|------------|---------|--------------|
| **哨兵-2** |欧空局 | 10-60m | 5 天 | 13个频段，免费使用|
| **陆地卫星 8/9** |美国地质勘探局| 30m | 16 天 |历史档案（1972+）|
| **MODIS** |美国宇航局 | 250-1000m |每日 |植被指数|
| **行星镜** |星球 | 3m|每日 |商业，高分辨率|
| **世界观** |麦克萨 | 0.3m |变量|非常高分辨率|
| **哨兵-1** |欧空局 | 5-40m | 6-12 天 |全天候SAR |
| **环境卫星** |欧空局 | 30m | 35 天 | SAR（存档）|
